      ...
      <footer className="footer max-w-7xl mx-auto py-10 flex flex-col items-center gap-10">
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
          ...
          <aside className="flex-1 text-center md:text-left">
            <img
              className="lg:max-w-36 md:max-w-28 max-w-26 h invert brightness-0 mx-auto md:mx-0"
              src="https://i.ibb.co/JFKwYhjk/Chat-GPT-Image-Jun-13-2025-09-40-13-AM.png"
              alt="Logo"
            />
            <p className="italic text-md mt-2">Healthy food healthy life.</p>
          </aside>
          ...
          <nav className="flex-1 text-center md:text-left">
            ...
            <ul className="flex flex-col gap-2">
              ...
              {user && (
                <>
                  <li>
                    <NavLink to="/my-foods">My Food</NavLink>
                  </li>
                  <li>
          ...
          <nav className="flex-1 text-center md:text-left">
            ...
            <div className="grid grid-flow-col gap-4 justify-center md:justify-start">
              <a href="https://x.com/savorlyc" aria-label="Twitter">
                <svg
              ...
              <a
                href="https://www.youtube.com/c/SavorySaver"
                aria-label="YouTube"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="http://facebook.com/savorybd" aria-label="Facebook">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
